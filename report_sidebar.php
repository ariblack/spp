	...
	<center>
		<img src="images/logo.png">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li <?php if($page == "Bayar") echo "class='active'";?>><a href="report_payment.php"><i class="icon-chevron-right icon-large"></i><i class="icon-money icon-large"></i> Laporan Pembayaran </a></li>
						<li <?php if($page == "Ringkasan") echo "class='active'";?>><a href="report_summary.php"><i class="icon-chevron-right icon-large"></i><i class="icon-table icon-large"></i> Ringkasan Pembayaran </a></li>
